  ...
  return (
    <div className="screen-enter relative flex-1 overflow-hidden bg-nes-coffee flex flex-col">
      ...
      <div className="relative z-10 text-center pt-3">
        ...
        <p className="mt-2 text-white/75 text-[11px] tracking-[0.25em] font-semibold">TOTAL A PAGAR</p>
        <p className="font-serif-nes text-nes-gold-text text-[44px] leading-none mt-1">{fmt(amount)}</p>
      </div>
      ...
      >
        <ContactlessIcon className="w-[250px] h-[250px]" />
